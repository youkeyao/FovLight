...
def main(checkpoint_dir, model_param):
    ...
    with torch.no_grad():
        for batch in dataloader:
            ...
            envmap = model(pos.to(device), projection_matrix.to(device), image.to(device), depth.to(device), True)
            end_time = time.time()
            ...
            render_new = renderer.render_sphere(render_pos, envmap)[:, :, ::-1]
            ...
            cv2.imshow("image", linear_to_srgb(image_np))
            ...
            cv2.imshow("render", linear_to_srgb(np.hstack((render_old, render_new))))
...
if __name__ == "__main__":
    ...
    # main("checkpoints_new2/voxel_5", ((84, 60, 64), (320, 640), 100, 4))
    # main("checkpoints/voxel_6", ((67, 48, 51), (320, 640), 100, 4))
    # main("checkpoints_new2/voxel_7", ((50, 36, 38), (320, 640), 100, 4))
    # main("checkpoints/voxel_8", ((34, 24, 26), (320, 640), 100, 4))
    # main("checkpoints/voxel_9", ((17, 12, 13), (320, 640), 100, 4))

    # main("checkpoints_new2/network_0", ((168, 120, 128), (320, 640), 100, 3))
    # main("checkpoints_new2/network_1", ((168, 120, 128), (320, 640), 100, 2))
    # main("checkpoints_new2/network_2", ((168, 120, 128), (320, 640), 100, 1))
